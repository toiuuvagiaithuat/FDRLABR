...
system_config = {
    ...
    "local_epochs": 10,         # number of epochs client ru before send its weights to server
    "test_period": 20,          # test for each 10 global iterations after exploration phase
    "users_per_round": 5,      # number of client chosen per round
...
log_config = {
    "dir_name": "./resultsTuned_nstep5/" + str(env_config["train_data"]) + \
